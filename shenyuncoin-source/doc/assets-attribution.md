The following is a list of assets used in the shenyuncoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://shenyuncointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original shenyuncoin logo from Bitboy)
* License: MIT
